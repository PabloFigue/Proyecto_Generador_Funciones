...
SOURCEFILES_QUOTED_IF_SPACED=Proyecto.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Proyecto.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Proyecto.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Proyecto.o

# Source Files
SOURCEFILES=Proyecto.s
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/MPLAB.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Proyecto.o: Proyecto.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Proyecto.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/Proyecto.o \
	Proyecto.s \
...
${DISTDIR}/MPLAB.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/MPLAB.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
